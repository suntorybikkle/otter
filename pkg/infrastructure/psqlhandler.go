...
func (handler *PsqlHandler) Execute(statement string, args ...interface{}) (interfaces.Result, error) {
...
func (handler *PsqlHandler) Query(statement string, args ...interface{}) (interfaces.Row, error) {
	psqlRow := new(PsqlRow)
...
func NewPsqlHandler(dbfileName string) interfaces.SqlHandler {
